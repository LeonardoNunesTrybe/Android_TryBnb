...
import com.betrybe.trybnb.data.models.DataReservation

class ReservationAdapter(private val reservationList: List<DataReservation>) :
    Adapter<ReservationAdapter.ReservationViewHolder>() {

        class ReservationViewHolder(private val view: View) : ViewHolder(view) {
            var guestName: TextView = view.findViewById(R.id.name_item_reservation)
            var checkinDate: TextView = view.findViewById(R.id.checkin_item_reservation)
            var checkoutDate: TextView = view.findViewById(R.id.checkout_item_reservation)
    ...
    override fun onBindViewHolder(holder: ReservationViewHolder, position: Int) {
        ...
        holder.guestName.text = firstName + lastName
        holder.checkinDate.text = reservationList[position].bookingDates.checkin
        holder.checkoutDate.text = reservationList[position].bookingDates.checkout
